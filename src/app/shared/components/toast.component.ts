  ...
  template: `
    <div class="fixed top-4 right-4 z-50 space-y-2">
      @for (toast of toastService.toasts(); track toast.id) {
        <div 
          class="min-w-80 rounded-lg border p-4 shadow-lg animate-slide-in"
          [ngClass]="{
            'bg-red-900 border-red-700 text-red-100': toast.type === 'error',
            'bg-green-900 border-green-700 text-green-100': toast.type === 'success',
            'bg-yellow-900 border-yellow-700 text-yellow-100': toast.type === 'warning',
